function [Idfuncs,lambdas,SLambda,dfuncs] = basisFuncCom(MM,m,covFunc,lx,ly,lz,sig_f,nhat,entry,exit,req,X,Y,Z,nsegs)
% [dfuncs,Idfuncs] = basisFuncCom(MM,m,covFunc,lx,ly,lz,sig_f,nhat,entry,exit,req,X,Y,Z)
