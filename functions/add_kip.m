function [ Kip_new ] = add_kip( entry_new, exit_new, nhat_new, P_all,Kip_old, GP )
%[ Kip_new ] = add_kip( entry_new, exit_new, nhat_new, P_all,Kii_old, GP )
%   Detailed explanation goes here
entry = entry_new;
exit = exit_new;
nhat = nhat_new;

disp('Adding observations to Kip')
tic
[n_test, ~] = size(P_all);
[~,n_obs] = size(entry);
sig_f1 = GP.sig_f1;
